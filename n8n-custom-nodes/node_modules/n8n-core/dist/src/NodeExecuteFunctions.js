...
async function proxyRequestToAxios(uriOrObject, options) {
    ...
    if (((_a = configObject.auth) === null || _a === void 0 ? void 0 : _a.sendImmediately) === false) {
        ...
        axiosPromise = new Promise(async (resolve, reject) => {
            var _a;
            try {
                const result = await (0, axios_1.default)(axiosConfig);
                resolve(result);
            }
            catch (resp) {
...
async function prepareBinaryData(binaryData, executionId, filePath, mimeType) {
    ...
    if (!mimeType) {
        ...
        if (!mimeType) {
            const fileTypeData = await (0, file_type_1.fromBuffer)(binaryData);
            if (fileTypeData) {
...
async function httpRequestWithAuthentication(credentialsType, requestOptions, workflow, node, additionalData, additionalCredentialOptions) {
    ...
    try {
        ...
        const data = await additionalData.credentialsHelper.preAuthentication({ helpers: { httpRequest: this.helpers.httpRequest } }, credentialsDecrypted, credentialsType, node, false);
        if (data) {
        ...
        if (((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) === 401 &&
            ...
            try {
                if (credentialsDecrypted !== undefined) {
                    const data = await additionalData.credentialsHelper.preAuthentication({ helpers: { httpRequest: this.helpers.httpRequest } }, credentialsDecrypted, credentialsType, node, true);
                    if (data) {
                        Object.assign(credentialsDecrypted, data);
                    }
                    requestOptions = await additionalData.credentialsHelper.authenticate(credentialsDecrypted, credentialsType, requestOptions, workflow, node, additionalData.timezone);
...
async function requestWithAuthentication(credentialsType, requestOptions, workflow, node, additionalData, additionalCredentialOptions) {
    ...
    try {
        ...
        requestOptions = await additionalData.credentialsHelper.authenticate(credentialsDecrypted, credentialsType, requestOptions, workflow, node, additionalData.timezone);
        return await proxyRequestToAxios(requestOptions);
    }
    catch (error) {
        try {
            if (credentialsDecrypted !== undefined) {
...
function getAdditionalKeys(additionalData, mode) {
    ...
    return ((workflow, node) => {
        return {
            ...
            getNodeParameter: (parameterName, fallbackValue, options) => {
                ...
                return getNodeParameter(workflow, runExecutionData, runIndex, connectionInputData, node, parameterName, itemIndex, mode, additionalData.timezone, getAdditionalKeys(additionalData, mode), undefined, fallbackValue, options);
            },
            getRestApiUrl: () => {
    ...
    return ((workflow, runExecutionData, connectionInputData, inputData, node) => {
        return {
            ...
            evaluateExpression: (expression, itemIndex) => {
                return workflow.expression.resolveSimpleParameterValue(`=${expression}`, {}, runExecutionData, runIndex, itemIndex, node.name, connectionInputData, mode, additionalData.timezone, getAdditionalKeys(additionalData, mode), executeData);
            },
            ...
            getNodeParameter: (parameterName, itemIndex, fallbackValue, options) => {
                return getNodeParameter(workflow, runExecutionData, runIndex, connectionInputData, node, parameterName, itemIndex, mode, additionalData.timezone, getAdditionalKeys(additionalData, mode), executeData, fallbackValue, options);
            },
            getMode: () => {
                return mode;
            },
            ...
            getWorkflowDataProxy: (itemIndex) => {
                const dataProxy = new n8n_workflow_1.WorkflowDataProxy(workflow, runExecutionData, runIndex, itemIndex, node.name, connectionInputData, {}, mode, additionalData.timezone, getAdditionalKeys(additionalData, mode), executeData);
    ...
    return ((workflow, runExecutionData, connectionInputData, inputData, node, itemIndex) => {
        return {
            ...
            evaluateExpression: (expression, evaluateItemIndex) => {
                ...
                return workflow.expression.resolveSimpleParameterValue(`=${expression}`, {}, runExecutionData, runIndex, evaluateItemIndex, node.name, connectionInputData, mode, additionalData.timezone, getAdditionalKeys(additionalData, mode), executeData);
            },
            getContext(type) {
                return n8n_workflow_1.NodeHelpers.getContext(runExecutionData, type, node);
            },
            ...
            helpers: {
                async getBinaryDataBuffer(propertyName, inputIndex = 0) {
                    return getBinaryDataBuffer.call(this, inputData, itemIndex, propertyName, inputIndex);
                },
                httpRequest,
                async requestWithAuthentication(credentialsType, requestOptions, additionalCredentialOptions) {
    ...
    return ((workflow, node) => {
        const that = {
            ...
            getNodeWebhookUrl: (name) => {
                return getNodeWebhookUrl(name, workflow, node, additionalData, mode, additionalData.timezone, getAdditionalKeys(additionalData, mode), isTest);
            },
            getTimezone: () => {
                return getTimezone(workflow, additionalData);
            },
...
function getExecuteWebhookFunctions(workflow, node, additionalData, mode, webhookData) {
    return ((workflow, node) => {
        return {
            ...
            getNodeWebhookUrl: (name) => {
                return getNodeWebhookUrl(name, workflow, node, additionalData, mode, additionalData.timezone, getAdditionalKeys(additionalData, mode));
            },
            getTimezone: () => {
                return getTimezone(workflow, additionalData);
            },
