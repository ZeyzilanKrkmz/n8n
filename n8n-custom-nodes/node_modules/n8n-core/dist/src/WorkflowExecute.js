            ...
            if (incomingNodeConnections === undefined) {
                ...
                for (const connections of incomingNodeConnections.main) {
                    for (let inputIndex = 0; inputIndex < connections.length; inputIndex++) {
                        ...
                        if ((_a = workflow.getNode(connection.node)) === null || _a === void 0 ? void 0 : _a.disabled)
                            continue;
                    ...
                    for (let tryIndex = 0; tryIndex < maxTries; tryIndex++) {
                        ...
                        try {
                            ...
                            if (pinData && !executionNode.disabled && pinData[executionNode.name] !== undefined) {
                                ...
                                const runNodeData = await workflow.runNode(executionData, this.runExecutionData, runIndex, this.additionalData, _1.NodeExecuteFunctions, this.mode);
